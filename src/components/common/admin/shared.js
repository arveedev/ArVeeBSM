...
export const inputClass =
  'mt-1 w-full rounded-xl border border-neutral-800 bg-neutral-950 px-3 py-2 text-white outline-none transition-colors focus:border-brand-neon'

export const labelClass = 'text-xs text-neutral-400'

export const primaryButtonClass =
  'rounded-xl bg-brand-neon px-3 py-2 text-sm font-semibold text-neutral-950 transition-all hover:brightness-110 hover:shadow-[0_0_16px_rgba(0,255,163,0.45)] active:scale-95'

export const secondaryButtonClass =
  'rounded-xl border border-neutral-800 bg-neutral-900 px-3 py-2 text-sm font-medium text-neutral-300 transition-all hover:border-neutral-600 hover:text-white active:scale-95'
...
export const editIconClass = `${iconButtonClass} text-neutral-400 hover:text-white hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.5)]`
